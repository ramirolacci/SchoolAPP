...
export const ModulesPitch: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header section */}
      <div className="bg-gradient-to-r from-slate-900 via-blue-950/60 to-slate-900 rounded-2xl p-6 text-white shadow-lg border border-blue-500/30 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <button
          ...
          className={`p-5 rounded-2xl border text-left transition-all relative overflow-hidden group cursor-pointer ${
            activeModule === 'licencias'
              ...
              : 'bg-[#1e293b] text-slate-200 border-slate-700 hover:border-blue-500/50 hover:shadow-md'
          }`}
        >
          <div className="flex items-center justify-between mb-3">
            <div className={`p-3 rounded-xl ${
              activeModule === 'licencias' ? 'bg-white/20 text-white' : 'bg-blue-500/15 text-blue-300'
            }`}>
          ...
          <p className={`text-xs mt-1.5 leading-relaxed ${activeModule === 'licencias' ? 'text-blue-100' : 'text-slate-400'}`}>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className={`p-3 rounded-xl ${
              activeModule === 'tesoreria' ? 'bg-white/20 text-white' : 'bg-blue-500/15 text-blue-300'
            }`}>
          ...
          <p className={`text-xs mt-1.5 leading-relaxed ${activeModule === 'tesoreria' ? 'text-blue-100' : 'text-slate-400'}`}>
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className={`p-3 rounded-xl ${
              activeModule === 'autogestion' ? 'bg-white/20 text-white' : 'bg-blue-500/15 text-blue-300'
            }`}>
          ...
          <p className={`text-xs mt-1.5 leading-relaxed ${activeModule === 'autogestion' ? 'text-blue-100' : 'text-slate-400'}`}>
      ...
      {activeModule === 'licencias' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#1e293b] rounded-2xl border border-slate-700 p-6 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-slate-700 pb-3">
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded-xl px-3 py-2 text-xs font-semibold text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <div className="space-y-2 pt-2">
                  ...
                  {mockSupplements.map((sup) => (
                    <div 
                      key={sup.id}
                      className="p-3 bg-[#0f172a] rounded-xl border border-slate-700 flex items-center justify-between text-xs"
                    >
                      <div>
                      ...
                      <button
                        ...
                        className="bg-blue-600 hover:bg-blue-500 text-white font-bold px-3 py-1.5 rounded-lg transition shadow-2xs text-[11px] cursor-pointer"
                      >
                        Asignar Cobertura
                      </button>
                    </div>
              ...
              <div className="space-y-4 text-xs">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0f172a] border border-slate-700 rounded-xl px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 font-semibold"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0f172a] border border-slate-700 rounded-xl px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="p-3 bg-blue-950/40 border border-blue-500/30 rounded-xl text-blue-300 flex items-start gap-2 text-[11px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#1e293b] rounded-2xl border border-slate-700 p-6 shadow-xs space-y-4">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="relative border-2 border-dashed border-slate-700 rounded-2xl p-6 text-center hover:border-blue-500 bg-[#0f172a]">
                  <input 
                    type="file" 
                    accept=".csv,.xlsx,.xls"
                ...
                {isImporting && (
                  <p className="text-center font-bold text-blue-400 animate-pulse">
              ...
              <form onSubmit={handleAdvanceSubmit} className="space-y-3 text-xs">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0f172a] border border-slate-700 rounded-xl px-3 py-2 text-white font-bold text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-2.5 rounded-xl transition shadow-sm cursor-pointer"
                >
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#1e293b] rounded-2xl border border-slate-700 p-6 shadow-xs space-y-4">
              ...
              <div className="space-y-3 text-xs">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-2.5 rounded-xl transition shadow-sm flex items-center justify-center gap-2 cursor-pointer"
                >
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-slate-800 hover:bg-slate-700 text-blue-300 font-bold py-2.5 rounded-xl border border-slate-700 transition flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-bold py-2.5 rounded-xl transition shadow-sm flex items-center justify-center gap-1.5 cursor-pointer"
                  >
            ...
            <div className="bg-[#1e293b] rounded-2xl border border-slate-700 p-6 shadow-xs space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 bg-[#0f172a] rounded-xl border border-slate-700 flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white font-semibold px-3 py-1.5 rounded-lg transition cursor-pointer"
                  >
                    Sincronizar
                  </button>
                </div>
                ...
                <div className="p-4 bg-blue-950/40 border border-blue-500/30 rounded-xl text-blue-300 text-center space-y-1">
