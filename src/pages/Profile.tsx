...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {/* Profile Header Card */}
      <div className="bg-[#1e293b] rounded-2xl border border-slate-700 shadow-md overflow-hidden backdrop-blur-xs">
        {/* Cover Accent */}
        <div className="h-32 bg-gradient-to-r from-slate-900 via-blue-950/60 to-slate-900 border-b border-blue-900/40 relative">
          <div className="absolute right-4 bottom-3 bg-[#0f172a]/80 backdrop-blur-xs text-blue-300 text-xs px-3 py-1 rounded-full border border-blue-500/40 font-medium">
            Agente Activo DGCyE
          </div>
        </div>
        ...
        <div className="px-6 pb-6 pt-0 relative">
          ...
          <div className="mt-6 border-t border-slate-800 pt-6">
            ...
            {isEditing ? (
              <form onSubmit={handleSaveProfile} className="space-y-4 max-w-lg bg-[#0f172a] p-4 rounded-xl border border-slate-700">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#1e293b] text-slate-400 text-xs rounded-xl px-3 py-2 border border-slate-700"
                  />
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#1e293b] text-white text-xs rounded-xl px-3 py-2 border border-slate-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  />
                </div>
