...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 sm:p-6 bg-[#0f172a] text-slate-100 transition-colors duration-200">
      ...
      <div className="max-w-md w-full space-y-6">
        ...
        {/* Login Card */}
        <div className="bg-[#1e293b] rounded-3xl border border-slate-700 shadow-xl p-6 sm:p-8 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition font-mono"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                  required
                />
              </div>
            </div>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#1e293b] px-3 text-slate-400 font-semibold">
                O Modo Demostración
              </span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-blue-950/40 hover:bg-blue-900/40 text-blue-300 border-2 border-blue-500/40 font-bold p-3.5 rounded-2xl transition-all shadow-sm flex items-center justify-between text-left group"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xs uppercase tracking-wider text-blue-400 font-extrabold block">
