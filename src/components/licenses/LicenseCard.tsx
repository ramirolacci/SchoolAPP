...
export const LicenseCard: React.FC<LicenseCardProps> = ({ license, onSelect }) => {
  return (
    <div 
      ...
      className="bg-[#1e293b] border border-slate-700 rounded-2xl p-5 shadow-md hover:shadow-lg transition-all cursor-pointer hover:border-blue-500/50 group relative overflow-hidden"
    >
      {/* Accent left line */}
      <div 
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
        <div className="flex items-center gap-2">
          <span className="text-xs font-mono font-semibold px-2 py-0.5 rounded bg-[#0f172a] text-slate-300 border border-slate-700">
            {license.id}
          </span>
      ...
      {/* Diagnosis Preview */}
      <div className="bg-[#0f172a] rounded-xl p-3 text-xs text-slate-300 border border-slate-700 my-2">
      ...
      {/* Footer link */}
      <div className="flex items-center justify-between pt-3 border-t border-slate-700 mt-3 text-xs text-slate-400">
